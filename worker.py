...
class UtilitiesWorker:
    ...
    def _load_cookie(driver, login: str):
    ...
    @staticmethod
    def driver_selenium(pth_chromedriver:str, pth_chrome:str): # C:\Program Files\Google\Chrome\Application\chrome.exe
...
class Worker(UtilitiesWorker):
    ...
    def _driver_init(self):
        self.driver = UtilitiesWorker.driver_selenium(self.chromedriver, self.chrome)
